...
for batch in data:
    ...
    mechanism: {
      ...
      diagram: {
        height: 50,
        nodes: [
          { id: 'start', x: 14, y: 12, label: 'θ₀', sub: 'parameters before the step', kind: 'io', w: 10 },
          ...
          { id: 'step', x: 90, y: 34, label: 'θ₁', sub: 'a safe step', kind: 'io', w: 10 },
        ],
        edges: [
          { from: 'start', to: 'grad' },
          { from: 'grad', to: 'gate' },
    ...
    mechanism: {
      ...
      diagram: {
        ...
        nodes: [
          ...
          { id: 'l1a', x: 30, y: 26, label: 'LSTM₁', kind: 'box', w: 14 },
          { id: 'l1b', x: 62, y: 26, label: 'LSTM₁', kind: 'box', w: 14 },
          { id: 'l2a', x: 30, y: 10, label: 'LSTM₂', kind: 'box', w: 14 },
          { id: 'l2b', x: 62, y: 10, label: 'LSTM₂', kind: 'box', w: 14 },
    ...
    mechanism: {
      ...
      diagram: {
        ...
        nodes: [
          ...
          { id: 't0', x: 12, y: 34, label: 't₀', sub: 'two clean regions', kind: 'mem', w: 8 },
